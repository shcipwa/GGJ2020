...
namespace FullscreenEditor {
    ...
    public static class FullscreenPreferences {
        ...
        public static readonly PrefItem<bool> MosaicIgnoresPrimary;
        ...
        static FullscreenPreferences() {
            ...
            MosaicIgnoresPrimary = new PrefItem<bool>("MosaicPrimary", false, "Mosaic Ignores Primary", "Mosaic only to non primary monitors");
